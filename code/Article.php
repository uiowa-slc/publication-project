...
class Article extends Page {
	...
	public function getCMSFields() {
		...
		$fields->addFieldToTab('Root.ArticleText', UploadField::create('PrintableArticle', 'Downloadable/printable version of the article')->setFolderName('issues/'.$this->Parent()->URLSegment));
		$fields->addFieldToTab('Root.ArticleText', new HTMLEditorField('Content', 'Article text'));
